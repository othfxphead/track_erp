...
const menuItems: MenuItem[] = [
  ...
  { id: "favoritos", label: "Favoritos", icon: <Star className="w-5 h-5" />, path: "/favoritos" },
  {
    ...
    submenu: [
      ...
      { label: "Notas emitidas", path: "/notas-emitidas" },
  ...
  { id: "compras", label: "Compras", icon: <ShoppingCart className="w-5 h-5" />, path: "/compras" },
  {
    ...
    submenu: [
      ...
      { label: "Extrato Bancário", path: "/financeiro/extrato" },
      { label: "DDA", path: "/financeiro/dda" },
      { label: "Inadimplentes", path: "/financeiro/inadimplentes" },
    ],
  },
