...
export default function ContasPagar() {
  ...
  const totalPago = contas
    ...
    .reduce((acc, c) => acc + parseFloat(c.valorPago || "0"), 0);
          ...
          <CardContent className="pt-6">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-2xl font-bold">{formatCurrency(totalPago.toString())}</p>
              </div>
            </div>
          </CardContent>
        </Card>
                    ...
                    <TableCell className="text-right">
                      <ActionButton
                        actions={[
                          ...
                          {
                            icon: ActionIcons.Pay,
                            label: "Pagar",
                            onClick: () => toast.info("Pagar conta #" + conta.id),
                          },
                          {
